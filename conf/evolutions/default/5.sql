...
INSERT INTO components (id, brand, cost, is_required, model, name, power_cost, preview_img_hash, weight) VALUES
    (1, 'Cooler Master', 9000, TRUE, NULL, 'HAF XB EVO', 0, 'f35616c34e048cecfcae108ae4bc2e5122d24ddd', 8200),
    (2, 'Phanteks', 1900, TRUE, 'Tempered Glass ATX', 'Enthoo EVOLV', 0, 'b0852c33d4318bfd6add77108a2df0d98e246591', 10200);
...
INSERT INTO components (id, brand, cost, is_required, model, name, power_cost, preview_img_hash, weight) VALUES
    (3, 'Cooler Master', 3000, TRUE, NULL, 'Hyper 212 EVO', 3, '22e9fed360792b373b7dc68db2eb406d88287807', 580);
...
INSERT INTO components (id, brand, cost, is_required, model, name, power_cost, preview_img_hash, weight) VALUES
    (4, 'MSI', 54400, FALSE, NULL, 'GTX 1080 ARMOR', 180, '5a09e0572c6df937677e88ecbc63b3227503ab51', 907);
...
INSERT INTO components (id, brand, cost, is_required, model, name, power_cost, preview_img_hash, weight) VALUES
    (5, 'Crucial', 6800, TRUE, NULL, 'Ballistix Sport LT', 10, 'da990a739305587be4d86ee7b1af8d26734eb353', 145),
    (6, 'Crucial', 8000, TRUE, NULL, 'Vengeance LPX', 10, '67c85ed0426c70fe036869a289ee7d33a006f0c2', 82);
...
INSERT INTO components (id, brand, cost, is_required, model, name, power_cost, preview_img_hash, weight) VALUES
    (7, 'ASUS', 14000, TRUE, NULL, 'Z170-A', 0, '76c0de5b635ce0218d3e93c624477a1191caf9a1', 998),
    (8, 'MSI', 10000, TRUE, NULL, 'B350 TOMAHAWK', 0, '0e253d917915e5906039602979b3e5f2cca77675', 1270);
...
INSERT INTO components (id, brand, cost, is_required, model, name, power_cost, preview_img_hash, weight) VALUES
    (9, 'Corsair', 16000, TRUE, NULL, 'HX750i', 0, '61b2604330f1de8e1ee9664f593adf200452fc17', 3227);
...
INSERT INTO components (id, brand, cost, is_required, model, name, power_cost, preview_img_hash, weight) VALUES
    (10, 'Intel', 33500, TRUE, '7700K', 'Core i7', 91, '679728054f9cef2385c126a87c7c8b6a72858c57', 95),
    (11, 'Intel', 20000, TRUE, '6500', 'Core i5', 35, '1a0b45411cbcacff658ccc53dd1b45e825adfe3a', 295),
    (12, 'Intel', 12000, TRUE, '6100', 'Core i3', 51, '65585aec19cd1c534a08298d825270ffaf56a734', 272),
    (13, 'AMD', 43000, TRUE, '1800X', 'Ryzen 7', 95, 'bb4f2700cafcc1407b1e40d762218b4f46cee390', 119);
...
INSERT INTO components (id, brand, cost, is_required, model, name, power_cost, preview_img_hash, weight) VALUES
  (14, 'Samsung', 15000, TRUE, NULL, '850 EVO', 2, 'da31f153b942eb7879bed43490b67c5d395bf894', 54);
