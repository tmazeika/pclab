...
<head>
    ...
    <link rel="mask-icon" href="{{ asset('safari-pinned-tab.svg') }}" color="#61d43a">
    <meta name="apple-mobile-web-app-title" content="PCForge">
    <meta name="application-name" content="PCForge">
