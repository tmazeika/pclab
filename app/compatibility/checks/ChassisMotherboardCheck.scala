...
class ChassisMotherboardCheck extends Check[ChassisWithRelated, MotherboardWithRelated] {
  override def isIncompatible(chassis: ChassisWithRelated, motherboard: MotherboardWithRelated): Boolean =
